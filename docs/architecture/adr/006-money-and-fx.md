...
Mọi report/test so sánh số nguyên. Helper money có unit test (`QA-P0-*`); bảng chuẩn transfer: [transfer-balance-test-cases.md](../transfer-balance-test-cases.md). Cấu trúc bảng: [ADR 007](007-core-data-model.md).
