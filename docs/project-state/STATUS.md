...
- **Mobile auth:** `MOB-P1-001` done: email auth, secure session, PIN/biometric lock, privacy cover và quản lý phiên. Analyze + 33 tests + native builds pass; smoke SMTP/biometric thiết bị thực trước store. [Chi tiết](../architecture/mobile-auth.md).
