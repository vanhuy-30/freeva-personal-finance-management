...
- **Audit schema:** `BE-P0-004` done (ADR 008, migration + SQL regression PostgreSQL 16). Chưa writer/event và bảo vệ sửa/xóa. Phase 0: 20/24 task done.
...
1. `BE-P0-005` — thử backup/restore
